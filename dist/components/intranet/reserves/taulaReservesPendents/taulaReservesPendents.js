...
export const carregarDadesTaulaReservesPendents = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Corregir la URL
        ...
        const opcionesFormato2 = {
            day: '2-digit',
            month: '2-digit',
            year: 'numeric',
        };
        const opcionesFormato3 = {
            year: 'numeric'
        };
        // Procesar los datos para renderizar la tabla
        const tableBody = document.querySelector('#pendents tbody');
