...
<thead class="table-dark">
	...
	<?php if (!empty($result)) {
     foreach ($result as $row) {
         ...
         $string2 =
             'Tu reserva,Servicio de lavado exterior + aspirado tapicería interior';
         ...
         echo '<td>' .
             $modelo1 .
             " // <a href='canvi-matricula.php?&idReserva=" .
             $idReserva .
             "'>" .
             $matricula1 .
             '</a></td>';
         echo '<td>';
         if (empty($vuelo1)) {
             echo "<a href='afegir-vol.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-secondary btn-sm' role='button' aria-pressed='true'>Añadir</a>";
         } else {
             echo "<a href='canvi-vol.php?&idReserva=" .
                 $idReserva .
                 "'>" .
                 $vuelo1 .
                 '</a>';
         ...
         echo '<td>';
         if ($checkIn == 5) {
             echo "<a href='fer-checkin.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-secondary btn-sm' role='button' aria-pressed='true'>Fer Check-In</a>";
         } elseif ($checkIn == 1) {
             echo "<a href='fer-checkout.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-secondary btn-sm' role='button' aria-pressed='true'>Fer Check-Out</a>";
         } elseif ($checkOut == 2) {
         ...
         echo '<td>';
         if (empty($idReserva)) {
             echo "<a href='afegir-nota.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-info btn-sm' role='button' aria-pressed='true'>Crear notas</a>";
         } elseif (!empty($idReserva) && empty($notes)) {
             echo "<a href='afegir-nota.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-info btn-sm' role='button' aria-pressed='true'>Crear notas</a>";
         } elseif (!empty($notes)) {
             echo "<a href='veure-nota.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-danger btn-sm' role='button' aria-pressed='true'>Ver notas</a>";
         }

         echo '</td>';
         echo '<td>';
         if (empty($idReserva)) {
             echo "<a href='afegir-buscador.php?&idReserva=" .
                 $idReserva .
                 "' class='btn btn-warning btn-sm' role='button' aria-pressed='true'>Alta en buscador</a>";
             ...
             echo '' .
                 $nombre .
                 " <a href='modificar-buscador.php?&idReserva=" .
                 $idReserva .
                 "'>(deshacer)</a>";
         }
         echo '</td>';
