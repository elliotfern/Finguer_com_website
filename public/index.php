...
<div class="row text-center justify-content-center servicios" style="margin-top:20px">
        <div class="col-12 col-md-2 mx-3">
            <img src="/img/icons-pago-online.svg" alt="Servicios" height="140px"/>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#fecha_reserva").datepicker({
                ...
                numberOfMonths: 1, // Mostrar dos meses
            ...
            function validarFechas() {
                ...
                if (fechaInicio < fechaActual || horasDiferencia < 12) {
                    $('#mensaje_error').text('Tu fecha de llegada al parking debe ser almenos 24 horas antes de hacer la reserva.');
                    return false;
                }
